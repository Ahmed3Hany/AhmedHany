...
<html lang="en">
  ...
  <body>
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu border-2" aria-labelledby="projectsDropdown">
                  <li><a href="DesktopApplicationProjects.php" class="nav-link p-2 pb-0 p-lg-3 pb-lg-0 dropdown-item active"><i class="fa-brands fa-windows fa-xl pe-2"></i>Desktop Application</a></li>
    ...
    <div class="desktop text-center pt-5 pb-5" id="projects">
      <div class="container">
        <div class="main-title mt-5 mb-5 position-relative">
          <h2 class="fw-bold">Desktop Application Projects</h2>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-4 border border-primary border-3 rounded">
            <h4 class="mb-3 mt-3"><u>DSC System</u></h4>
            <iframe width="100%" height="300px" src="https://www.youtube.com/embed/EOmMVnB8zo4?si=0dRibEN0jX8LHYLF" allowfullscreen></iframe>
          </div>
