...
<html lang="en">
  ...
  <body>
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu border-2" aria-labelledby="projectsDropdown">
                  ...
                  <li><a class="nav-link p-2 pb-0 p-lg-3 pb-lg-0 dropdown-item" href="WebDesignProjects.php"><i class="fa-solid fa-globe fa-xl pe-2"></i>Web Design</a></li>
                  <li><a href="RoboticsProjects.php" class="nav-link p-2 p-lg-3 dropdown-item active"><i class="fa-solid fa-robot fa-xl pe-2"></i>Robotics & Electronics</a></li>
                </ul>
              </li>
    ...
    <div class="graphic text-center pt-5 pb-5" id="projects">
      <div class="container">
        <div class="main-title mt-5 mb-5 position-relative">
          <h2 class="fw-bold">Robotics & Electronics Projects</h2>
        </div>
        <div class="row">
          <div class="col-md-6 col-lg-4 border border-primary border-3 rounded">
            <h4 class="mb-3 mt-3"><u>Arduino Remote Car</u></h4>
            <iframe width="100%" height="300px" src="https://www.youtube.com/embed/hMQxMHBw-ts?si=yCpFso4K6CZOnHKp" allowfullscreen></iframe>
          </div>
